...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Diagramme de Cas d'Utilisation.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{authentication_usecase_diagram.png}
...
\textbf{Table} & \textbf{Description} & \textbf{Champs Clés} \\
\hline
\texttt{h8pd_product} & Produits principaux & \texttt{rowid}, \texttt{ref}, \texttt{label}, \texttt{price}, \texttt{tva\_tx} \\
\hline
